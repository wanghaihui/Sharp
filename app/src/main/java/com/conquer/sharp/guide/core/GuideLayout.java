...
import com.conquer.sharp.guide.listener.AnimationListenerAdapter;
...
public class GuideLayout extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        Log.d(Guide.TAG, "GuideLayout onDraw");
    ...
    private void drawHighlights(Canvas canvas) {
        ...
        if (highLights != null) {
            for (HighLight highLight : highLights) {
                ...
                notifyDrawListener(canvas, highLight, rectF);
            }
        }
    }

    private void notifyDrawListener(Canvas canvas, HighLight highLight, RectF rectF) {
        HighlightOptions options = highLight.getOptions();
        if (options != null) {
            if (options.onHighlightDrawListener != null) {
    ...
    protected void onAttachedToWindow() {
        ...
        Log.d(Guide.TAG, "GuideLayout onAttachToWindow");
        addCustomViewToLayout(guidePage);
    ...
    private void addCustomViewToLayout(GuidePage guidePage) {
        removeAllViews();
            ...
            if (viewIds != null && viewIds.length > 0) {
                for (int viewId : viewIds) {
                    ...
                    if (click != null) {
                        ...
                        Log.w(Guide.TAG, "can't find the view by id : " + viewId + " which used to remove guide page");
                    }
                }
            }
